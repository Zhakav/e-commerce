...
public class SecurityConstants {
    ...
    public static final String USER_REGISTER_PATH = "/user/register"; // Public path that clients can use to register.
    public static final String ADMIN_REGISTER_PATH = "/admin/register/adminType/**"; // Public path that clients can use to register.
}
